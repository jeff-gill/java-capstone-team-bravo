			...
			<div class="col-md-2">
				<div class="text-left button btn-group">
					...
					<a href="" class="text-left" data-toggle="modal"
						data-target="#modalProfilePicForm"><button>Update
							Profile Image!</button></a>
				</div>
				<div class="modalButton">
					...
					<div class="text-left button btn-group">
						<a href="" class="mb-4" data-toggle="modal"
							data-target="#modalProfileInfoForm"><button>Update
	...
	<div class="container-fluid"
		...
		<div class="row button">
			...
			<div class="col-md-2 button btn-group">
				<div class="text-left">
					<a href="" class="mb-4 classInfoButton" data-toggle="modal"
						data-target="#modalClassInfoForm"><button>View
							Classes</button> </a>
				</div>
